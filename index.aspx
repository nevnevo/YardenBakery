<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="HomePage.aspx.cs" Inherits="YardenLaviUnfus.HomePage" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
   ...
   <style>
        @import url('https://fonts.googleapis.com/css2?family=Anton&family=Mukta:wght@200;300;400;500;600;700;800&family=Protest+Guerrilla&display=swap');
        body {
    ...
    <h1>Welcome to Beast's bakeries!</h1>

</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div style="margin: 100px 200px;">
        <button id="MenuButton" class="button" ><a href="Menu.aspx"; style="text-decoration-line:none; color:black">Menu</a></button>
    ...
    <img class="nigga1" src="pics/rcmd1.png" />
