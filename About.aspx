<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="YardenLaviUnfus.About1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <h1>About the bakery:</h1>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <p>Yarden was a nice child that liked to bake and he saw he is very good at it so he started </br> selling them</p>
    </br>
    </br>
    </br>
    <p>Nevo was a wholsome kid, and at age 11 he learned ho program that yadi yada he sold a website</p>
